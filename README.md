...
1. **Churn Rate by Engagement Profile**  
   - Visualizes how active/inactive and product usage impacts churn.  

2. **Churn Rate by Number of Products**  
   - Shows retention differences between single-product and multi-product customers.  

3. **High-Value Disengaged Customers**  
   - Detects premium customers who may churn despite high balances.  
...
5. **Interactive Filters**  
   - Engagement profiles, number of products, balance, and salary thresholds  
